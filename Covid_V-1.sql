...
Select location, MAX(total_cases) as HighestInfectionCount, population, Max((total_cases/population)) as infection_percentage 
From portfolio_project.dbo.covid_deaths
...
-- countries with most vaccination (either one dose or more)
